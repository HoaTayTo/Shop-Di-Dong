...
<body>
    ...
    <div class="container_status">
        {{-- <div class="sidebar">
            ...
            <a style="width: 250px;background-color:#e0e0e0" href="{{ route('status.State7') }}">Đơn hàng đã mua</a>
            <a style="margin: 20px 0px" href="#" class="menu-button"class="filter-button">Thông tin và sổ địa
                chỉ</a>
            <a href="{{ route('user.logout') }}" class="logout-button" class="filter-button">Đăng Xuất</a>
        </div> --}}
        <div class="sidebar">
            <h2 style="margin-right: 30px">Xin chào: {{ session('UserName') }}</h2>
            <a href="{{ route('status.State7') }}" class="filter-button">Đơn hàng đã mua</a>
            <a href="#" class="menu-button filter-button">Thông tin và sổ địa chỉ</a>
            <a href="{{ route('user.logout') }}" class="logout-button filter-button">Đăng Xuất</a>
        </div>
