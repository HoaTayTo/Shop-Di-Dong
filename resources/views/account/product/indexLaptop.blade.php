                                ...
                                <div class="main_products">
                                    @foreach ($product as $item)
                                        <div class="item_content">
                                            <a href="./detailsproduct/{{ $item->id }}">
                                                <img src="./Image_products/{{ $item->img }}" alt="" style="width: 80%"></a>
                                            <div class="item_text">
                                                <li>
                                                    <a href="./detailsproduct/{{ $item->id }}">
                                                        <h3>{{ $item->name }}</h3>
                                                ...
                                                <li >
                                                    <a style="color: red; font-weight:bold; font-size: 16px" href="#">{{ number_format($item->getDiscountedPrice(), 0, '.', '.') }}<sup>đ</sup></a>
                                                </li>
                                                @foreach ($item->config_Products as $it)
                                                    <div class="config">
                                                        <li>Ram: {{ $it->ram }}</li>
                                                        <li>Màn hình: {{ $it->screen }}</li>
                                                        <li>CPU: {{ $it->CPU }}</li>
                                                        <li>Card: {{ $it->card_ }}</li>
                                                        <li>Pin: {{ $it->pin }}</li>
                                                        <li>Khối lượng: {{ $it->KTKL }}</li>
                                                    </div>
                                                @endforeach
                                                <li>
