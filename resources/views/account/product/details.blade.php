                    ...
                    <div class="container_cau_hinh_san_pham">
                        @foreach ($product->config_Products as $item)
                            <div class="content_cau_hinh_san_pham">
                                <ul>
                                    <li>
                                        <p>Màn hình: </p> <span>{{ $item->led }}</span>
                                    </li>
                                    <li>
                                        <p>Hệ điều hành: </p><span>{{ $item->operating_system }}</span>
                                    </li>
                                    <li>
                                        <p>Camera sau:</p><span>{{ $item->camera_behind }}</span>
                                    </li>
                                    <li>
                                        <p>Camera trước:</p><span>{{ $item->camera_front }}</span>
                                    </li>
                                    <li>
                                        <p>Chip:</p><span>{{ $item->chip }}</span>
                                    </li>
                                    <li>
                                        <p>RAM:</p><span>{{ $item->ram }}</span>
                                    </li>
                                    <li>
                                        <p>Dung lượng lưu trữ:</p><span>{{ $item->capacity }}</span>
                                    </li>
                                    <li>
                                        <p>Pin, Sạc:</p><span>{{ $item->pin }}</span>
                                    </li>
                                </ul>
                            </div>
                        @endforeach
