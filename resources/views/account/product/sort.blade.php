            ...
            <div class="menu_checkbox_locSP">
                <form id="filterForm" method="GET" action="{{ route('product.Sort') }}">
                    <ul>
                        ...
                        <li>
                            <input type="checkbox" name="discount" id="discount" onchange="submitForm(this)" {{ $request->has('discount') ? 'checked' : '' }}>Giảm giá
                        </li>
                        <li>
                            <input type="checkbox" name="limit" id="limit" onchange="submitForm(this)" {{ $request->has('limit') ? 'checked' : '' }}>Sản phẩm đặc quyền
                        </li>
                        <li>
                            <input type="checkbox" name="asc" id="tangdan" onchange="submitForm(this)" {{ $request->has('asc') ? 'checked' : '' }}>Giá tăng dần
                        </li>
                        <li>
                            <input type="checkbox" name="desc" id="giamdan" onchange="submitForm(this)" {{ $request->has('desc') ? 'checked' : '' }}>Giá giảm dần
                        </li>
                    </ul>
                </form>
            </div>
                                    ...
                                    @foreach ($product as $item)
                                        <div class="item_content">
                                            ...
                                            <div class="item_text">
                                                ...
                                                <li><a href="./detailsproduct/{{ $item->id }}"><h3>{{ $item->name }}</h3>
                                                    </a></li>
